...
export default function Kontak() {
  return (
    <>
      <Head>
        <title>Kontak - Mitra Bangunindobaja</title>
        <meta name="description" content="Hubungi Mitra Bangunindobaja untuk konsultasi dan pemesanan material bangunan. Layanan pelanggan terbaik dan respon cepat." />
      </Head>
      ...
      <main className="pt-16">
        ...
        <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-12">
          <div className="container mx-auto px-4">
            ...
            <p className="text-xl">Siap membantu kebutuhan material bangunan Anda</p>
          </div>
        </section>
                ...
                <form className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      rows="4"
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      placeholder="Tuliskan pesan atau kebutuhan material Anda..."
                    ></textarea>
                  </div>
                  <button
                    type="submit"
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@mitrabangunindobaja.com</p>
                      <p className="text-gray-600">sales@mitrabangunindobaja.com</p>
                    </div>
                  </div>
