    ...
    <footer className="relative bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 text-white overflow-hidden">
        ...
        <div className="border-t border-white/10 py-8">
          <div className="bg-gradient-to-r from-blue-600/20 to-indigo-600/20 backdrop-blur-sm rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Bergabunglah dengan WhatsApp Group kami untuk mendapatkan
              informasi harga terbaru, promo menarik, dan tips konstruksi dari
              para ahli.
            </p>
            <a
              href="https://wa.me/6281244677317"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center space-x-3 bg-gradient-to-r from-green-500 to-green-600 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:from-green-600 hover:to-green-700 transition-all duration-300 hover:scale-105 hover:shadow-xl"
            >
              <span className="text-2xl">💬</span>
        ...
        <div className="border-t border-white/10 py-8">
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            ...
            <div className="flex items-center space-x-2 text-gray-400">
              ...
              <span>for Indonesian Builders</span>
            </div>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="group w-14 h-14 bg-gradient-to-r from-green-500 to-green-600 rounded-full flex items-center justify-center shadow-2xl hover:shadow-green-500/50 transition-all duration-300 hover:scale-110 animate-bounce hover:animate-none"
        >
          <span className="text-2xl text-white group-hover:scale-125 transition-transform duration-200">
            💬
          </span>
          <div className="absolute -inset-1 bg-gradient-to-r from-green-400 to-green-600 rounded-full opacity-20 group-hover:opacity-40 blur transition-all duration-300"></div>
        </a>
      </div>
    </footer>
  );
